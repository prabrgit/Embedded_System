...
# define X_ENgnd  5 //ENA-(ENA) stepper motor enable , active low     Gray 
# define X_EN_5v  7 //ENA+(+5V) stepper motor enable , active low     Orange
# define X_DIRgnd 4 //DIR-(DIR) axis stepper motor direction control  Blue
# define X_DIR_5v 2 //DIR+(+5v) axis stepper motor direction control  Brown
# define X_STPgnd 6 //PUL-(PUL) axis stepper motor step control       Black
# define X_STP_5v 3 //PUL+(+5v) axis stepper motor step control       RED
# define M0 10
# define M1 9
# define M2 8 
